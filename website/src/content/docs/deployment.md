---
title: "Deployment"
description: "Run hermes-router on Windows, macOS, Linux, Docker, or a Hugging Face Space — step by step."
---
...
`PROXY_API_KEYS`, model `hermes-router`. See [usage.md](/usage/) for full examples
...
- No keys loaded, or all of them are rate-limited. Confirm a key is set (`hr auth list`, or
  check your `.env`/secrets), and add more — see [providers.md](/providers/).
